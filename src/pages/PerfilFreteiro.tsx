  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            {user ? (
              ...
              <div className="flex space-x-4">
                <Link to="/cadastro">
                  <Button variant="outline" className="text-blue-600 border-2 border-blue-600 hover:bg-blue-50 rounded-xl px-6 py-3 font-semibold">
                    Cadastrar-se
                  </Button>
                </Link>
                <Link to="/login">
                  <Button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl px-6 py-3 font-semibold">
                    Entrar
                  </Button>
                </Link>
              </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Main Profile Card */}
        <Card className="shadow-2xl border-0 rounded-3xl overflow-hidden bg-white mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-blue-50 p-6 rounded-2xl">
                    <h4 className="font-semibold text-gray-700 mb-2">Tipo de Veículo</h4>
                    <p className="text-xl font-bold text-blue-600">{freteiro.veiculo}</p>
                  </div>
                  <div className="bg-purple-50 p-6 rounded-2xl">
                    <h4 className="font-semibold text-gray-700 mb-2">Tempo Estimado</h4>
                    <p className="text-xl font-bold text-purple-600">{freteiro.tempo}</p>
                  </div>
                </div>
                <div className="bg-gray-50 p-6 rounded-2xl">
                  <h4 className="font-semibold text-gray-700 mb-4">Especificações</h4>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-600">Capacidade:</span>
                      <span className="font-semibold ml-2">500kg</span>
                    </div>
                    <div>
                      <span className="text-gray-600">Dimensões:</span>
                      <span className="font-semibold ml-2">2,3m x 1,5m x 1,7m</span>
                    </div>
                    <div>
                      <span className="text-gray-600">Ano:</span>
                      <span className="font-semibold ml-2">2022</span>
                    </div>
                    <div>
                      <span className="text-gray-600">Combustível:</span>
                      <span className="font-semibold ml-2">Flex</span>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="shadow-xl border-0 rounded-3xl">
              ...
              <CardContent className="space-y-6">
                {avaliacoes.map((avaliacao) => (
                  <div key={avaliacao.id} className="border-b border-gray-200 pb-6 last:border-b-0">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          <h5 className="font-semibold text-gray-900">{avaliacao.nome}</h5>
                        ...
                        <div className="flex items-center space-x-1 mb-2">
                          {[...Array(5)].map((_, i) => (
                            <Star 
                              key={i} 
                              className={`h-4 w-4 ${i < avaliacao.rating ? 'text-yellow-400 fill-current' : 'text-gray-300'}`} 
                            />
                          ))}
                        </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="shadow-xl border-0 rounded-3xl">
              <CardHeader>
                <CardTitle className="text-xl font-bold text-gray-900">Contrato & Contato</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <Button 
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 py-4 text-lg font-bold rounded-2xl shadow-xl transform hover:scale-105 transition-all duration-300"
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-2 border-green-600 text-green-600 hover:bg-green-50 py-4 text-lg font-bold rounded-2xl"
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-2 border-purple-600 text-purple-600 hover:bg-purple-50 py-4 text-lg font-bold rounded-2xl"
            ...
            <Card className="shadow-xl border-0 rounded-3xl">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-600">3 anos</div>
                  <div className="text-gray-600">Na Plataforma</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-xl border-0 rounded-3xl">
              <CardHeader>
                <CardTitle className="text-xl font-bold text-gray-900">Certificações</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-600" />
                  <span className="text-gray-700">Documentos Verificados</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Award className="h-6 w-6 text-blue-600" />
                  <span className="text-gray-700">Freteiro Premium</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Shield className="h-6 w-6 text-purple-600" />
                  <span className="text-gray-700">Seguro Incluso</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Clock className="h-6 w-6 text-orange-600" />
                  <span className="text-gray-700">Pontualidade 95%</span>
                </div>
              </CardContent>
            </Card>
          </div>
